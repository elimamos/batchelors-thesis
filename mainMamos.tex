...
\chapter{Projekt programu wspomagającego komunikację z chorymi na ALS}
\section{Wybrane technologie}
\subsection{System operacyjny}
\subsection{QT}
\subsection{C++}
\section{Projekt interfejsu}
\section{Projekt interakcji}
\subsection{Diagram klas }
\subsection{Podsumowanie}
\chapter{Zastosowane rozwiązanie - implementacja}
\section{Opis rozwiązania}
\section{Opis klas zastosowanych }
\section{Testy}
\section{Wyniki}
